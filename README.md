<div align="center">
    ...
    <p>
        <a href="https://github.com/VseMirka200/lets_go_slavgorod/releases">
            <img src="https://img.shields.io/badge/Скачать_приложение-последняя_версия-success?style=for-the-badge&logo=android" alt="Скачать приложение" />
        </a>
</div>

# О приложении
**«Поехали! Славгород»** — мобильное приложение для отслеживания расписания городских автобусов. Разработано с целью предоставления пользователям быстрого доступа к актуальной информации о маршрутах и времени движения транспорта.«Поехали! Славгород» — мобильное приложение для отслеживания расписания городских автобусов. Разработано с целью предоставления пользователям быстрого доступа к актуальной информации о маршрутах и времени движения транспорта.
